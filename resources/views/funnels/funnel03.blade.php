...
@php
  ...
  $url = "https://oxas.tech/tienda-de-instagram-empresa";    
@endphp
<!-- Primary Meta Tags -->
<title>{{$titulo}}</title>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-6 mt-5">
              <h1 class="text-decorated text-center">¿Vendes Productos físicos y tu empresa aun no tienes Instagram Shopping?</h1>
