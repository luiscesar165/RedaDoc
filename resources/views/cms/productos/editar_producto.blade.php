    ...
    <form action="{{route('producto.actualizar', $product->id)}}" id="form" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-12 mb-4">
          <h5>Producto</h5>
          <input class="form-control" id="input_title" type="text" name="product" value="{{$product->product}}" placeholder="Titulo" maxlength="191">
        </div> 
        <div class="col-12 mb-4">
          <h5>Imagen</h5>
        ...
        <div class="col-12 mb-5">
          ...
          <input type="button" id="submit_button" class="btn btn-success px-5" value="Editar Producto">
        </div>
      </div>
    </form>
  </div>
