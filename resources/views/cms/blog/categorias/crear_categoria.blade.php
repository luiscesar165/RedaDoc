...
<section>
  ...
  <div class="">
    ...
    <form action="{{route('blog.category.store')}}" id="form" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
        ...
        <div class="col-12 mb-5">
          ...
          <input type="button" id="submit_button" class="btn btn-success px-5" value="Crear Categoría">
        </div>
      </div>
    </form>
  </div>
